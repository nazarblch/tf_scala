package native_types.core.graph;
...
@Platform(include = {
        "/home/nazar/tensorflow_scala/jni/src/main/native/include/tensorflow/core/graph/graph.h",
...
@Namespace("tensorflow") @NoOffset public class Node extends Pointer {
    static { Loader.load(); }
...
//    public native @Const @ByRef EdgeSet out_edges();
    ...
    public native @ByVal
    Status input_edge(int idx, @Cast("const tensorflow::Edge**") PointerPointer e);
