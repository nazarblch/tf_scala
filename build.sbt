...
lazy val examples = (project in file("./examples"))
    ...
    .settings(commonSettings)
    .settings(publishSettings)
    .settings(libraryDependencies ++= Seq("org.scalanlp" %% "breeze" % "0.13.2",
    ...
    .settings(resolvers += "Sonatype Releases" at "https://oss.sonatype.org/content/repositories/releases/")
